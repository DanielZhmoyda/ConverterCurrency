...
import com.test.danz.di.modules.DataModule;
import com.test.danz.presentation.MainActivity;
import javax.inject.Singleton;
import dagger.Component;

@Component(modules = {AppModule.class, RepositoryModule.class, InteractorModule.class, PresenterModule.class, DataModule.class })
@Singleton
